const TerminalOverlay = () => {
  return (
    <div className="absolute bottom-0 left-0 right-0 p-4">
      <div className="b-green-600 relative backdrop-blur-sm border border-border rounded-lg p-3 overflow-hidden font-mono">
        {/* Status bar */}
        ...
        {/* Title */}
        <h3 className="text-sm text-foreground mb-2 tracking-tight">
